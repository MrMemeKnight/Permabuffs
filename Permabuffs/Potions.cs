using System; using System.Collections.Generic; using Terraria; using TShockAPI;

namespace Permabuffs { public class Potions { public static Dictionary<string, int> BuffIDs = new Dictionary<string, int>();
